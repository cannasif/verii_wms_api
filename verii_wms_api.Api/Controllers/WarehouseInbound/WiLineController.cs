...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class WiLineController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateWiLineDto createDto, CancellationToken cancellationToken = default)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(long id, [FromBody] UpdateWiLineDto updateDto, CancellationToken cancellationToken = default)
        {
