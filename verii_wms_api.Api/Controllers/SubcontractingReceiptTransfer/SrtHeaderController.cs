...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class SrtHeaderController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<SrtHeaderDto>>>> GetPaged([FromBody] PagedRequest request, CancellationToken cancellationToken = default)
        {
            var result = await _service.GetPagedAsync(request, cancellationToken);
            return StatusCode(result.StatusCode, result);
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ApiResponse<SrtHeaderDto>>> GetById(long id, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<SrtHeaderDto>>>> GetByCustomerCode(string customerCode, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<SrtHeaderDto>>>> GetByDocumentType(string documentType, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<SrtHeaderDto>>>> GetByDocumentNo(string documentNo, CancellationToken cancellationToken = default)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResponse<SrtHeaderDto>>> Create([FromBody] CreateSrtHeaderDto createDto, CancellationToken cancellationToken = default)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ApiResponse<SrtHeaderDto>>> Update(long id, [FromBody] UpdateSrtHeaderDto updateDto, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult<ApiResponse<SrtAssignedOrderLinesDto>>> GetAssignedOrderLines(long headerId, CancellationToken cancellationToken = default)
        {
        ...
        [HttpPost("generate")]
        public async Task<ActionResult<ApiResponse<SrtHeaderDto>>> Generate([FromBody] GenerateSubcontractingReceiptOrderRequestDto request, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<ActionResult<ApiResponse<int>>> BulkCreate([FromBody] BulkCreateSrtRequestDto request, CancellationToken cancellationToken = default)
        {
