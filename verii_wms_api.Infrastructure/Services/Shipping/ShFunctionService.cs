...
namespace WMS_WEBAPI.Services
{
    public class ShFunctionService : IShFunctionService
    {
        ...
        public ShFunctionService(IUnitOfWork unitOfWork, IMapper mapper, ILocalizationService localizationService, IExecutionContextAccessor executionContextAccessor, IRequestCancellationAccessor requestCancellationAccessor)
        {
