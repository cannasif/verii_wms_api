...
namespace WMS_WEBAPI.Services
{
    public class ShLineService : IShLineService
    {
        ...
        public ShLineService(IUnitOfWork unitOfWork, IMapper mapper, ILocalizationService localizationService, IErpService erpService, IRequestCancellationAccessor requestCancellationAccessor)
        {
