...
namespace WMS_WEBAPI.Services
{
    public class PrParameterService : IPrParameterService
    {
        ...
        public async Task<ApiResponse<PagedResponse<PrParameterDto>>> GetPagedAsync(PagedRequest request)
        {
            try
            {
                ...
                var query = _unitOfWork.PrParameters.AsQueryable().Where(x => !x.IsDeleted);
