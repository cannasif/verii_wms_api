...
namespace WMS_WEBAPI.Services
{
    public class SrtFunctionService : ISrtFunctionService
    {
        ...
        public SrtFunctionService(IUnitOfWork unitOfWork, IMapper mapper, ILocalizationService localizationService, IExecutionContextAccessor executionContextAccessor, IRequestCancellationAccessor requestCancellationAccessor)
        {
