...
namespace WMS_WEBAPI.Services
{
    public class WoImportLineService : IWoImportLineService
    {
        ...
        public async Task<ApiResponse<PagedResponse<WoImportLineDto>>> GetPagedAsync(PagedRequest request)
        {
            try
            {
                ...
                var query = _unitOfWork.WoImportLines.Query().Where(x => !x.IsDeleted);
