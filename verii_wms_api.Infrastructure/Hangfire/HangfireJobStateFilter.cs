                ...
                if (_options.EnableFailureSqlLog)
                {
                    try
                    {
                        ...
                        unitOfWork.JobFailureLogs.AddAsync(new JobFailureLog
                        {
                            ...
                            StackTrace = failedState.Exception?.StackTrace?.Length > 4000
                                ? failedState.Exception.StackTrace[..4000]
                    ...
                    {
                        _logger.LogWarning(ex, "JobFailureLog SQL kaydi basarisiz. JobId: {JobId}", jobId);
                    }
                }
