...
public sealed class GrHeaderConfiguration : BaseHeaderEntityConfiguration<GrHeader>
{
    protected override void ConfigureEntity(EntityTypeBuilder<GrHeader> builder)
    {
        ...
        builder.Property(x => x.Description1).HasMaxLength(100).HasColumnName("Description1");
        builder.Property(x => x.Description2).HasMaxLength(100).HasColumnName("Description2");
        builder.Property(x => x.Description3).HasMaxLength(100).HasColumnName("Description3");
        builder.Property(x => x.Description4).HasMaxLength(100).HasColumnName("Description4");
