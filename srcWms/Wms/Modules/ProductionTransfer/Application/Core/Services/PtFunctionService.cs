...
public sealed class PtFunctionService : IPtFunctionService
{
    private readonly IPtFunctionReadRepository _repo;
    private readonly ILocalizationService _localizationService;
    private readonly IMapper _mapper;

    public PtFunctionService(IPtFunctionReadRepository repo, ILocalizationService localizationService, IMapper mapper)
    {
        _repo = repo;
