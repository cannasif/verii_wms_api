...
[Authorize]
public sealed class WtLineSerialController : ControllerBase
{
    private readonly IWtLineSerialService _service;

    public WtLineSerialController(IWtLineSerialService service)
    {
        _service = service;
    }
    ...
    public async Task<ActionResult<ApiResponse<IEnumerable<WtLineSerialDto>>>> GetByLineId(long lineId, CancellationToken cancellationToken = default)
    {
