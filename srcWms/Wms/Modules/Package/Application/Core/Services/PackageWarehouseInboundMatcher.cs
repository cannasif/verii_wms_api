...
public sealed class PackageWarehouseInboundMatcher : IPackageWarehouseInboundMatcher
{
    ...
    public PackageWarehouseInboundMatcher(
    ...
    public async Task<ApiResponse<long>> MatchPackageLineToWarehouseInboundAsync(PHeader header, PLine packageLine, CancellationToken cancellationToken = default)
    {
        ...
        {
            existingImportLine = new WiImportLine
            {
