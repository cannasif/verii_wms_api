...
public sealed class PackageWarehouseOutboundMatcher : IPackageWarehouseOutboundMatcher
{
    ...
    public PackageWarehouseOutboundMatcher(
    ...
    public async Task<ApiResponse<long>> MatchPackageLineToWarehouseOutboundAsync(PHeader header, PLine packageLine, CancellationToken cancellationToken = default)
    {
        ...
        {
            existingImportLine = new WoImportLine
            {
