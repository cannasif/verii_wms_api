...
public sealed class PackageShippingMatcher : IPackageShippingMatcher
{
    ...
    public async Task<ApiResponse<long>> MatchPackageLineToShippingAsync(PHeader header, PLine packageLine, CancellationToken cancellationToken = default)
    {
        ...
        {
            existingImportLine = new ShImportLine
            {
