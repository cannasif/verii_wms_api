...
public sealed class WoHeaderConfiguration : BaseHeaderEntityConfiguration<WoHeader>
{
    protected override void ConfigureEntity(EntityTypeBuilder<WoHeader> builder)
    {
        ...
        builder.HasIndex(x => x.CustomerId).HasDatabaseName("IX_WoHeader_CustomerId");
        builder.HasIndex(x => x.SourceWarehouseId).HasDatabaseName("IX_WoHeader_SourceWarehouseId");
        builder.HasIndex(x => x.TargetWarehouseId).HasDatabaseName("IX_WoHeader_TargetWarehouseId");
