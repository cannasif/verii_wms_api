...
public interface IPrHeaderService
{
    ...
    Task<ApiResponse<PrHeaderDetailDto>> GetDetailAsync(long id, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<PagedResponse<PrHeaderDto>>> GetAssignedProductionOrdersPagedAsync(long userId, PagedRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<PrHeaderDto>> CreatePlanAsync(CreateProductionPlanRequestDto request, CancellationToken cancellationToken = default);
    Task<ApiResponse<PrHeaderDto>> UpdatePlanAsync(long id, CreateProductionPlanRequestDto request, CancellationToken cancellationToken = default);
    Task<ApiResponse<ProductionPlanDraftDto>> GetErpTemplateAsync(ProductionErpTemplateRequestDto request, CancellationToken cancellationToken = default);
