...
public sealed class ShParameterController : ControllerBase
{
    private readonly IShParameterService _service;

    public ShParameterController(IShParameterService service)
    {
        _service = service;
    }
