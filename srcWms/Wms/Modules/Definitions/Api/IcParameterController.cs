...
public sealed class IcParameterController : ControllerBase
{
    private readonly IIcParameterService _service;

    public IcParameterController(IIcParameterService service)
    {
        _service = service;
    }
