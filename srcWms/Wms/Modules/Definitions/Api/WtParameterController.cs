...
public sealed class WtParameterController : ControllerBase
{
    private readonly IWtParameterService _service;

    public WtParameterController(IWtParameterService service)
    {
        _service = service;
    }
