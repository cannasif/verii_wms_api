...
public sealed class PParameterController : ControllerBase
{
    private readonly IPParameterService _service;

    public PParameterController(IPParameterService service)
    {
        _service = service;
    }
