...
public sealed class SrtParameterController : ControllerBase
{
    private readonly ISrtParameterService _service;

    public SrtParameterController(ISrtParameterService service)
    {
        _service = service;
    }
