...
public interface IIcHeaderService
{
    ...
    Task<ApiResponse<PagedResponse<IcHeaderDto>>> GetAssignedPagedAsync(long userId, PagedRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<bool>> GenerateLinesAsync(long id, CancellationToken cancellationToken = default);
