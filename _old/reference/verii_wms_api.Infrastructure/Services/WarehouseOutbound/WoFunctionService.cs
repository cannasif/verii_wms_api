...
namespace WMS_WEBAPI.Services
{
    public class WoFunctionService : IWoFunctionService
    {
        ...
        public WoFunctionService(IUnitOfWork unitOfWork, IMapper mapper, ILocalizationService localizationService, ICurrentUserService executionContextAccessor, IRequestCancellationAccessor requestCancellationAccessor)
        {
