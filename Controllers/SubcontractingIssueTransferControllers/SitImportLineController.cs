...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class SitImportLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<SitImportLineDto>>>> GetPaged([FromBody] PagedRequest request)
        {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<SitImportLineWithRoutesDto>>>> SubcontractingIssueTransferOrderCollectedBarcodes(long headerId)
        {
