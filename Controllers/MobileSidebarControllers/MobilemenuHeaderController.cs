...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class MobilemenuHeaderController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<MobilemenuHeaderDto>>>> GetPaged([FromBody] PagedRequest request)
        {
            var result = await _mobilemenuHeaderService.GetPagedAsync(request);
            return StatusCode(result.StatusCode, result);
        }
