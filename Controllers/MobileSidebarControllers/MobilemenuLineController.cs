...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class MobilemenuLineController : ControllerBase
    {
        ...
        [HttpPost("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<MobilemenuLineDto>>>> GetPaged([FromBody] PagedRequest request)
        {
            var result = await _mobilemenuLineService.GetPagedAsync(request);
            return StatusCode(result.StatusCode, result);
        }
